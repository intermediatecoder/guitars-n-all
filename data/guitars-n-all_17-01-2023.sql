...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2023 at 07:30 AM
...
INSERT INTO `carts` (`id`, `profile_id`, `created_at`) VALUES
(1, 1, '2023-01-17 05:32:33'),
(2, 2, '2023-01-17 05:32:33'),
(3, 3, '2023-01-17 05:32:33'),
(4, 4, '2023-01-17 05:32:33'),
(5, 5, '2023-01-17 05:32:33'),
(6, 6, '2023-01-17 05:32:33');
...
INSERT INTO `cart_items` (`id`, `seller_product_id`, `quantity`, `cart_id`) VALUES
(1, 1, 10, 3),
(2, 2, 1, 3),
(3, 3, 3, 3),
(4, 4, 9, 3);
...
CREATE TABLE `profiles` (
  ...
  `description` varchar(8000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
